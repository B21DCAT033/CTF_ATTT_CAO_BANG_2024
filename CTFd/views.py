...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <h3 class="text-center">
            <p>Diễn Tập Ứng Cứu Sự Cố An Toàn Thông Tin Mạng Tỉnh Cao Bằng Năm 2024</p>
            <p>UBND TỈNH CAO BẰNG & BỘ THÔNG TIN VÀ TRUYỀN THÔNG</p>
          
           <a href="https://twitter.com/"><i class="fab fa-twitter fa-2x" aria-hidden="true"></i></a>&nbsp;
        ...
        <h4 class="text-center">
            <p>TRUNG TÂM CÔNG NGHỆ SỐ QUỐC GIA - CỤC CHUYỂN ĐỔI SỐ QUỐC GIA
        </h4>
    </div>
</div>"""
            page.content = index
